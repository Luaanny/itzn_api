...
from app.schemas.agenda import CriarAgenda, RespostaAgenda, ListaAgenda, DeletarAgenda, AtualizarAgenda
from app.sevices.agenda_service import (post_appointment, get_all_user_appointments,
                                        delete_user_appointment, update_user_appointment)
...
async def resgatar_agendamento(
        user_email: EmailStr,
        db: session_type,
        api_key: check_api_key
):
